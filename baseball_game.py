...
def is_duplicated_number(three_digit):
    ...
    # ===Modify codes below=============
    # 조건에 따라 변환되어야 할 결과를 result 변수에 할당
    return three_digit[0] == three_digit[1] or three_digit[0] == three_digit[2] or three_digit[1] == three_digit[2]
...
def get_not_duplicated_three_digit_number():
    ...
    while(True):
        ...
        if not is_duplicated_number(number):
            return number
...
def get_strikes_or_ball(user_input_number, random_number):
    ...
    for idx, num in enumerate(user_input_number):
        if num in random_number:
            ball_count += 1
            if num == random_number[idx]:
                ball_count-=1
                strike_count+=1
    # ==================================
...
def is_yes(one_more_input):
    ...
    # ===Modify codes below=============
    # 조건에 따라 변환되어야 할 결과를 result 변수에 할당
    check = one_more_input.upper()
    return check == 'Y' or check == 'YES'
